  ...
  th: {
    ...
    featured: {
      ...
      custom: {
        ...
        description:
          "ลองอัปโหลดรูปตัวละครหรือรูปอ้างอิง แล้วเลือกความสูงเพื่อเทียบกับคน 170 ซม. เหมาะกับนักสะสมที่อยากเริ่มชิ้นงานใหญ่ในราคาจับต้องได้",
        upload: "อัปโหลดรูปของคุณ",
        human: "คน 170 cm",
        model: "โมเดลตัวอย่าง",
    ...
    story: {
      ...
      subheadline:
        "บางชิ้นเริ่มจากโมเดล บางชิ้นต้องเทียบสเกลกับคนจริง ทุกงานถูกสร้างเพื่อให้เห็นภาพว่าของสะสมจะอยู่ในชีวิตจริงได้อย่างไร",
      items: [
    ...
    project: {
      ...
      subheadline:
        "ส่งรูปอ้างอิงมา เลือกขนาด แล้วเราช่วยประเมินให้ว่าควรเริ่มจากแบบไหน",
    ...
    footer:
      "เปลี่ยนตัวละครที่คุณรัก ให้กลายเป็นของสะสมที่ตั้งอยู่ในบ้านคุณได้จริง",
  },
  en: {
    nav: {
