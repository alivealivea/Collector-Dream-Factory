...
async function run() {
  ...
  try {
    ...
    const finalVideoPath = path.join(RENDERS_DIR, 'android18-voice2-promo.mp4');
    ...
    const filterComplex = [
      ...
      `[c_in1]adelay=2250|2250[c1];`,
      `[c_in2]adelay=6480|6480[c2];`,
      `[c_in3]adelay=8250|8250[c3];`,
      `[c_in4]adelay=10800|10800[c4];`,
      `[c_in5]adelay=20150|20150[c5];`,
      `[c_in6]adelay=23000|23000[c6];`,
      `[c_in7]adelay=27080|27080[c7];`,
      `[c_in8]adelay=31400|31400[c8];`,
      ...
      `[p_in1]adelay=260|260[p1];`,
      `[p_in2]adelay=3550|3550[p2];`,
      `[p_in3]adelay=5850|5850[p3];`,
      `[p_in4]adelay=8460|8460[p4];`,
      `[p_in5]adelay=10840|10840[p5];`,
      `[p_in6]adelay=14150|14150[p6];`,
      `[p_in7]adelay=19850|19850[p7];`,
      `[p_in8]adelay=22900|22900[p8];`,
      `[p_in9]adelay=26420|26420[p9];`,
      `[p_in10]adelay=29380|29380[p10];`,
      `[p_in11]adelay=31720|31720[p11];`,
      `[p_in12]adelay=35200|35200[p12];`,

      // Split and delay whooshes (3 whooshes in total)
      `[5:a]asplit=3[w_in1][w_in2][w_in3];`,
      `[w_in1]adelay=5620|5620[w1];`,
      `[w_in2]adelay=19680|19680[w2];`,
      `[w_in3]adelay=31380|31380[w3];`,
